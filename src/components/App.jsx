import { Component, nanoid, Report, Section, ContactForm, ContactList, Filter } from 'utils/allComponents';
    ...
    return (
      <>
        ...
        <Section title="Contacts">
          ...
          {contacts.length > 0 ?
            (<ContactList contacts={filterContact} deleteContact={this.deleteContact} />) : (Report.info('Contact list is empty!', ' ',
              'Ok',
            ))}
        </Section>
      </>
